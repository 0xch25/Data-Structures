...
References: Narasimha Karumanchi (https://github.com/careermonk/data-structures-and-algorithmic-thinking-with-python/blob/master/src/chapter15stringalgorithms/RobinKarp.py)
'''
